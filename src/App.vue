<script setup lang="ts">
  ...
  const links = ref([
    ...
    },
    {
      ...
      text: "Backend",
      name: "",
      link: "https://github.com/Eccsiren/valasztasok-homework-backend",
      disabled: false,
      separator: false,
    },
  ]);
        ...
        <q-scroll-area class="fit">
          ...
          <q-list>
            ...
            <q-item
              ...
              :to="{ name: 'qtableCandidate' }"
            >
              <q-item-section avatar>
                <q-icon name="mdi-table" />
              </q-item-section>
              <q-item-section>Edit Candidatess</q-item-section>
            </q-item>
            <q-separator />
          </q-list>
          <!-- links: -->
